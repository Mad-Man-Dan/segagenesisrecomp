 ...
 * gbarecomp C++ port and the snesrecomp C port, © Jrickey,
 * MIT OR Apache-2.0, used with permission. See THIRD-PARTY-LICENSES.md.
 *
 * Algorithm is identical to the gbarecomp/snesrecomp ports byte-for-byte;
 * only the leading comment is console-specific.
 */
