 ...
 * re-render of a guest audio engine (here the Genesis YM2612 FM + SN76489 PSG,
 * re-rendered at higher rate / less aliasing, optionally free of the YM2612
 * "ladder effect" DAC quirk) runs ALONGSIDE the canon hardware mix, never
 ...
 *
 * The canon (emulated YM2612/SN76489) output stays the verify oracle; the
 * shadow is never ground truth. If this verifier is wrong, the worst case is
 * "we keep playing the authentic hardware mix" — it cannot corrupt output.
 *
 ...
 */
#ifndef AUDIO_SHADOW_H
#define AUDIO_SHADOW_H
