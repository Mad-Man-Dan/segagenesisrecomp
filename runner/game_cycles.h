 ...
 *
 * The recompiler stamps each translated instruction with a cycle cost measured
 * by clown68000 at codegen time (see recompiler/src/cycle_probe.h) — that's what
...
/* Clown-measured cost for the instruction at ROM `addr`, or -1 if not present. */
